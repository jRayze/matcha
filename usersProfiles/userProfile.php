    ...
    <div class="container-fluid" style="margin-top: 56px;">
        <div class="row">
            ...
            <div class="col-md-9 offset-md-3 offset-sm-12 py-2" id="main" style='margin-top: 56px;'>
                ...
                <div id="carouselExampleIndicators" style="width: 500px; margin: auto;" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" style="margin: auto;">
                        <div class="carousel-item active">
                            <img src="../img/lachatteatamere.jpg" alt="..." class="img-thumbnail" style="margin: auto; width: auto;">
